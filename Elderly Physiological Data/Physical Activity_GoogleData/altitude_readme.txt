...
altitude_YYYY-MM-DD.csv               - Where YYYY-MM-DD is the starting date for the entries in the file.

Each entry has the following values:

    timestamp                         - Date and time at which the entry was logged.
    gain                              - Altitude gain in millimeters (and not level above sea; no gps data).
